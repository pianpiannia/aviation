		...
		<script type="text/javascript">
			function showDetail(oid){
				...
				if(but.value == "订单详情"){
					...
					// 3.打开连接
					xhr.open("GET","${pageContext.request.contextPath}/adminOrder_findOrderByOid.action?oid="+oid+"&time="+new Date().getTime(),true);
					// 4.发送
					xhr.send(null);
					but.value = "关闭";
				}else{
								...
								<tr
									...
									<s:iterator var="o" value="pageBean.list" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="8%">
												<s:property value="#o.price"/>
											</td>
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="8%">
												<s:date name="ordertime" format="yyyy-MM-dd HH:mm" />
											...
											<td align="center" style="HEIGHT: 22px">
												...
												<input style="padding: 0;float:right;" type="button" value="订单详情" id="but<s:property value="#o.oid"/>" onclick="showDetail(<s:property value="#o.oid"/>)"/>
											</td>
											<td align="center" style="HEIGHT: 22px"><a
										href="${pageContext.request.contextPath}/adminOrder_delete.action?oid=<s:property value="#o.oid"/>">
											<img
