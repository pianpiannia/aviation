...
<script language="JavaScript">
 function ok(){
    window.parent.parent.location.href='${ pageContext.request.contextPath }/customer_loginPage.action';
 }
    ...
    <td style="padding:30px; text-align:center"><table width="60%" border="0" cellspacing="0" style="margin-top:70px">
      <tr>
        ...
        <br />
          ...
          <a href="${pageContext.request.contextPath }/customer_registPage.action">注册</a>
          <a href="${ pageContext.request.contextPath }/customer_loginPage.action">登录</a>
         </td>
      </tr>
    </table>
    <h1>&nbsp;</h1></td>
