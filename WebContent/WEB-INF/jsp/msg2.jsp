...
<script language="JavaScript">
 function ok(){
    window.parent.parent.location.href='${pageContext.request.contextPath }/order_toMyOrder.action?page=1';
 }
    ...
    <td style="padding:30px; text-align:center"><table width="60%" border="0" cellspacing="0" style="margin-top:70px">
      <tr>
        ...
        <br />
          ...
          <a href="${pageContext.request.contextPath }/order_toMyOrder.action?page=1">我的订单</a>
         </td>
      </tr>
    </table>
    <h1>&nbsp;</h1></td>
