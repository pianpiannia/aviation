							...
							<th colspan="8">
								<div class="pagination">
									...
									<s:if test="pageBean.page != 1">
										<a
											href="${pageContext.request.contextPath }/route_findMoreCondition.action?&page=1"
											class="firstPage">&nbsp;</a>
										<a
											href="${pageContext.request.contextPath }/route_findMoreCondition.action?&page==<s:property value="pageBean.page-1"/>"
											class="previousPage">&nbsp;</a>
									</s:if>
									<s:iterator var="i" begin="1" end="pageBean.totalPage">
										<s:if test="pageBean.page != #i">
											<a
												href="${pageContext.request.contextPath }/route_findMoreCondition.action?&page==<s:property value="#i"/>"><s:property
													value="#i" /></a>
										</s:if>
										<s:else>
									...
									<s:if test="pageBean.page != pageBean.totalPage">
										<a class="nextPage"
											href="${pageContext.request.contextPath }/route_findMoreCondition.action?&page==<s:property value="pageBean.page+1"/>">&nbsp;</a>
										<a class="lastPage"
											href="${pageContext.request.contextPath }/route_findMoreCondition.action?&page==<s:property value="pageBean.totalPage"/>">&nbsp;</a>
									</s:if>
